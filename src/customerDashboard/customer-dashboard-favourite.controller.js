CustomerDashboardFavouriteCtrl.$inject = ['$state','localStorageService','$scope'];

export default function CustomerDashboardFavouriteCtrl($state, localStorageService, $scope) {
