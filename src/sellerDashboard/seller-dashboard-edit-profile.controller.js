SellerDashboardEditProfileCtrl.$inject = ['$state','localStorageService','$scope','SellerDashboardService','FileUploader'];

export default function SellerDashboardEditProfileCtrl($state, localStorageService, $scope, SellerDashboardService, FileUploader) {
  ...
  $scope.$on('$viewContentLoaded',function(){
    ...
    SellerDashboardService.getProfileData().then(function(res){
  ...
  $scope.doSaveProfileData = function (){    
    ...
    SellerDashboardService.saveProfileData($scope.profileData).then(function(res){
  ...
  $scope.doChangePassword = function(){
    ...
    SellerDashboardService.changePassword($scope.passwordData).then(function(res){
  ...
  var uploader = $scope.uploader = new FileUploader({
      url: 'http://localhost:3000/api/v1/merchant/dashboard/users/avatar/image/upload',      
  });
